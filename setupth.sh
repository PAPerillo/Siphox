# setupth.sh
#
# Setup siphox-take-home with nginx and gunicorn
#
# See for reference
...
OPUSER=ubuntu
PROJ_DIR=/home/$OPUSER/siphox-take-home

# NOTE: Update this address with your domain
SERVER_NAME="ec2-3-144-78-5.us-east-2.compute.amazonaws.com"  #

sudo chmod 755 /home/$OPUSER

# 2. Requires git SSH key
cd /home/$OPUSER
git clone git@github.com:sp-nconway/siphox-take-home-01.git
mv siphox-take-home-01 siphox-take-home
cd $PROJ_DIR
...
echo "$gunicorn_service_content" | sudo tee "$qserve_service_filename" >/dev/null
...
nginx_filename="/etc/nginx/sites-available/siphox-take-home"
